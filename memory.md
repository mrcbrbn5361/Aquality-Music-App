...
5. **Kalan UI/UX maddeleri** (`docs/UI-UX-SORUNLARI.md` — dosya Docs Engine tarafından kırpılmamış, 749 satır tam duruyor): tekrar (repeat) ikon ayrımı, şarkı sözü otomatik kaydırma, context menu ikonları.
