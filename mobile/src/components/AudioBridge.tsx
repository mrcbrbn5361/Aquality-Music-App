  ...
  return (
    <View style={styles.hiddenContainer} pointerEvents="none">
      <WebView
        ...
        onError={(e) => console.warn('[AudioBridge] WebView error:', e.nativeEvent.description)}
        onHttpError={(e) => console.warn('[AudioBridge] WebView HTTP error:', e.nativeEvent.statusCode, e.nativeEvent.url)}
      />
    </View>
  );
};
