...
Aquality Music is a professional-grade Electron desktop application that provides YouTube Music integration with a polished, native-like desktop experience. This release marks the first stable 1.0.0 version with production-ready features.
...
MIT License - Copyright (c) 2026 Aquality Music Team
